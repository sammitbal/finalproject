...
ggplot(df, aes(x = GameType, y = mean_totalxp)) +
...
ggplot(df, aes(x = GameType, y = mean_score)) +
  geom_boxplot(width = 5)+
  geom_col() +
  labs(title = "Distribution of Score by GameType", x = "Mean Score", y = "TotalXP") +
  theme_minimal()
