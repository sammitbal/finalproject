...
unique(as.character(Map_select$Choice))
...
unique(as.character(Map_select$Choice_clean))
...
Map_select <-
  Map_select %>%
  filter(Map1 != "Collateral Striek", Map1 != "Collaterol Strike", Map1 != "Deprogam", Map1 != "Miami Stirke", Map1 != "Riad", Map1 != "Collateral Striek", Map1 != "Ruah", Map1 != "Drive-in")
```



```{r}
table(Map_select$Map1)
```
...
Map_select <-
  Map_select %>%
  filter(Map2 != "Miami Sstrike", Map2 != "Miami Stirke", Map2 != "yamantau", Map2 != "Amrada Strike", Map2 != "Drive-in")
```

```{r}
table(Map_select$Map2)
```
